...
hl.animation({ leaf = "windows", enabled = true, speed = 3, bezier = "ml4w_ease_1", style = "popin 80%" })
hl.animation({ leaf = "windowsIn", enabled = true, speed = 3, bezier = "ml4w_ease_1", style = "popin 80%" })
hl.animation({ leaf = "windowsOut", enabled = true, speed = 3, bezier = "ml4w_ease_2", style = "popin 80%" })
