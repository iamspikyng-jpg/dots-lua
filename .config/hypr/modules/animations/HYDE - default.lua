...
hl.animation({ leaf = "windows", enabled = true, speed = 3, curve = "hypr_ease_1", style = "popin 80%" })
hl.animation({ leaf = "windowsIn", enabled = true, speed = 3, curve = "hypr_ease_1", style = "popin 80%" })
hl.animation({ leaf = "windowsOut", enabled = true, speed = 3, curve = "hypr_ease_2", style = "popin 80%" })
...
hl.animation({ leaf = "workspaces", enabled = true, speed = 3, curve = "hypr_ease_3", style = "slide" })
hl.animation({ leaf = "workspacesIn", enabled = true, speed = 2, curve = "hypr_ease_3", style = "slide" })
hl.animation({ leaf = "workspacesOut", enabled = true, speed = 2, curve = "hypr_ease_2", style = "slide" })
